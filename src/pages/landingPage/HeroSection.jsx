...
export default function HeroSection() {
    ...
    <>
      <div className="w-full lg:min-h-screen pt-[7.5rem] px-4 flex flex-col items-center font-general-sans">
        <p className="lg:text-center lg:text-[3.5rem] md:text-center md:text-[3.5rem]  font-semibold text-[2.813rem] lg:leading-[110%] leading-[120%] lg:max-w-[40%] md:max-w-[70%]">
